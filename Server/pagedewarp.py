...
def remap_image(name, img, small, page_dims, params):
    ...
    threshfile = '/home/lutca1320/img/{0}.png'.format(name)
...
def main(imgfile, nameofFile):

    outfiles = []
    small = resize_to_screen(imgfile)
    ...
    outfile = remap_image(name, imgfile, small, page_dims, params)
